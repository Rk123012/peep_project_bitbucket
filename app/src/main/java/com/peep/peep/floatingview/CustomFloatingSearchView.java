 ...
 * search.
 */
public class CustomFloatingSearchView extends FrameLayout {
    ...
    private SearchCustomAdapter mSuggestionsAdapter;
    private SearchCustomAdapter.OnBindSuggestionCallback mOnBindSuggestionCallback;
    ...
    public CustomFloatingSearchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    private void setupSuggestionSection() {
        ...
        mSuggestionsAdapter = new SearchCustomAdapter(getContext(), mSuggestionsTextSizePx,
     ...
     *                 adapter.
     */
    public void setOnBindSuggestionCallback(SearchCustomAdapter.OnBindSuggestionCallback callback) {
